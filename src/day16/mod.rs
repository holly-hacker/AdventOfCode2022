...
mod setup {
    ...
    pub fn optimize_input(input_info: &ValveInfo) -> ValveInfoWeighted {
    ...
    pub fn build_distance_map(valve_info: &ValveInfoWeighted) -> ValveDistanceMap {
    ...
    pub fn parse_input(input: &str) -> ValveInfo {
        input
            .split('\n')
            .map(|line| {
